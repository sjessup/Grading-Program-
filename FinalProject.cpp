...
void displayTotal()
{
	...
	cout << "A F is between 0% and 49%. " << endl << endl;	
	...
	if(inFile.is_open())
	{
		...
		if(grade >= 90)
		{
			cout << "You are getting an A+.    " << grade << "%" << endl << endl;
		...
		{
			cout << "You are getting a B+.     " << grade << "%" << endl << endl;
		...
		{
			cout << "You are getting a C+.     " << grade << "%" << endl << endl; 
		...
		{
			cout << "You are getting a D+.     " << grade << "%" << endl << endl; 
		...
		{
			cout << "You are getting a F.      " << grade << "%" << endl << endl;
